    ...
    <MainLayout>
      <Container fluid>
        ...
        <Row>
          ...
          <Col className="px-5 " md={3} style={{ backgroundColor: "#4DADB1", clipPath: "polygon(0 0, 100% 3%, 100% 95%, 0 95%)", marginTop: "20px", marginBottom: "20px", textAlign: "center", zIndex: "0" }}>
